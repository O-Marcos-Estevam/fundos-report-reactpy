...
def tabela_fundos(fundos: List[FundoData], mostrar_alertas: bool = False):
    ...
    if not fundos:
        return html.div(
            {"style": {"padding": "2rem", "text_align": "center", "color": "#999"}},
    ...
    def render_linha(fundo: FundoData):
        ...
        colunas = [
            # Nome
            html.td(
                {"style": {"padding": "12px", "font_weight": "600"}},
                fundo.nome
            ),
            # Tipo
            html.td(
            ...
            # PL
            html.td(
                {"style": {"padding": "12px", "text_align": "right"}},
                f"R$ {fundo.pl:,.2f}"
            ),
            # Caixa
            html.td(
        ...
        if mostrar_alertas:
            if fundo.tem_alertas():
                ...
                colunas.append(
                    html.td(
                        {"style": {"padding": "12px", "text_align": "center"}},
                        ...
                        html.th(
                            {
                                ...
                                "style": {
                                    "padding": "12px",
                                    "text_align": "left" if h in ["Fundo", "Tipo"] else "right" if h != "Alertas" else "center",
        ...
        html.table(
            ...
            html.thead(
                html.tr(
                    {"style": {"background": "#f5f5f5"}},
                    html.th(
                        {"style": {"padding": "12px", "text_align": "center", "border_bottom": "2px solid #ddd"}},
                        "Status"
                    ),
                    html.th(
                        {"style": {"padding": "12px", "text_align": "left", "border_bottom": "2px solid #ddd"}},
                        "Data/Hora"
                    ),
                    html.th(
                        {"style": {"padding": "12px", "text_align": "left", "border_bottom": "2px solid #ddd"}},
                    ...
                    html.th(
                        {"style": {"padding": "12px", "text_align": "right", "border_bottom": "2px solid #ddd"}},
                        "Tempo"
                    ),
                    html.th(
                        {"style": {"padding": "12px", "text_align": "left", "border_bottom": "2px solid #ddd"}},
