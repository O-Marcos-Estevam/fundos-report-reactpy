    ...
    try:
        ...
        fundos = {
            "FUNDO_A": FundoData(
                ...
                rentabilidade_dia=0.0029,
                rentabilidade_mes=1.45,
                rentabilidade_ano=12.8,
                sharpe=1.85,
                volatilidade=8.2,
                patrimonio_medio=15_100_000_000,
            ),
            "FUNDO_B": FundoData(
                ...
                rentabilidade_dia=0.0042,
                rentabilidade_mes=0.95,
                rentabilidade_ano=11.2,
                sharpe=2.15,
                volatilidade=3.5,
                patrimonio_medio=8_550_000_000,
            ),
            "FUNDO_C": FundoData(
                ...
                rentabilidade_dia=0.0065,
                rentabilidade_mes=2.15,
                rentabilidade_ano=18.5,
                sharpe=1.62,
                volatilidade=12.1,
                patrimonio_medio=22_200_000_000,
            ),
            "FUNDO_D": FundoData(
                ...
                rentabilidade_dia=0.0038,
                rentabilidade_mes=1.12,
                rentabilidade_ano=13.5,
                sharpe=1.98,
                volatilidade=4.2,
                patrimonio_medio=5_880_000_000,
            ),
            "FUNDO_E": FundoData(
                ...
                rentabilidade_dia=0.0044,
                rentabilidade_mes=1.75,
                rentabilidade_ano=15.3,
                sharpe=1.72,
                volatilidade=9.8,
                patrimonio_medio=12_400_000_000,
            ),
        }
