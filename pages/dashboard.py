    ...
    return container_pagina(
        ...
        html.div(
            {
                "style": {
                    "display": "grid",
                    "grid_template_columns": "repeat(auto-fit, minmax(450px, 1fr))",
                    "gap": "2rem",
                    "margin_bottom": "2rem",
                }
            },
        ...
        html.div(
            ...
            *[
                html.div(
                    ...
                    html.div(
                        {"style": {"font_size": "0.9rem", "color": "#666"}},
                        html.p(
                            {"style": {"margin": "0.5rem 0"}},
        ...
        html.div(
            ...
            card_info(
                "📊 Estatísticas Adicionais",
                html.div(
                    {"style": {"display": "grid", "grid_template_columns": "repeat(auto-fit, minmax(200px, 1fr))", "gap": "1rem"}},
                    html.div(
                        html.p({"style": {"margin": "0", "color": "#666", "font_size": "0.85rem"}}, "Maior PL"),
                        html.p(
                            {"style": {"margin": "0.25rem 0 0 0", "font_weight": "600", "font_size": "1.1rem"}},
                            f"{max(fundos, key=lambda f: f.pl).nome}"
                        ),
                        html.p(
                            {"style": {"margin": "0", "color": "#999", "font_size": "0.85rem"}},
                            f"R$ {max(fundos, key=lambda f: f.pl).pl/1000000:.1f}M"
                        ),
                    ),
                    html.div(
                        html.p({"style": {"margin": "0", "color": "#666", "font_size": "0.85rem"}}, "Maior Caixa"),
                        html.p(
                            {"style": {"margin": "0.25rem 0 0 0", "font_weight": "600", "font_size": "1.1rem"}},
                    ...
                    html.div(
                        html.p({"style": {"margin": "0", "color": "#666", "font_size": "0.85rem"}}, "Maior Var. D-1"),
                        html.p(
                            {"style": {"margin": "0.25rem 0 0 0", "font_weight": "600", "font_size": "1.1rem", "color": "#10b981"}},
                            f"{max(fundos, key=lambda f: f.variacao_d1).nome}"
                        ),
                        html.p(
                            {"style": {"margin": "0", "color": "#10b981", "font_size": "0.85rem", "font_weight": "600"}},
                            f"+{max(fundos, key=lambda f: f.variacao_d1).variacao_d1:.2f}%"
                        ),
                    ),
                    html.div(
                        html.p({"style": {"margin": "0", "color": "#666", "font_size": "0.85rem"}}, "Fundos com Alerta"),
                        html.p(
                            {"style": {"margin": "0.25rem 0 0 0", "font_weight": "600", "font_size": "1.1rem", "color": "#f59e0b"}},
